...
| 버전 | 날짜 | 주요 변경 |
|------|------|----------|
| v1.4.4 | 2026-06-15 | 알림 명언과 앱 홈 오늘의 명언 동기화 수정 |
| v1.4.1 | 2026-05-27 | Play Store 프로덕션 출시용 버전 업데이트 |
| v1.4.0 | 2026-05-21 | Gemini 실시간 생성 제거 + 1,800개 명언 풀 기반 1일 1배달 + JSDelivr 원격 캐시 |
