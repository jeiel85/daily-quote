...
## v1.4.4 - 2026-06-15
### 🐛 수정 (Fix)
- 알림으로 도착한 명언과 앱 홈의 오늘의 명언이 서로 달라질 수 있던 문제 수정
- 오늘 이미 캐시된 명언이 있어도, 같은 날짜에 예약된 알림 명언이 있으면 알림 명언을 오늘의 기준으로 맞추도록 개선
- 오래된 서버 Cron/FCM 명언 생성 경로를 제거해 로컬 알림 기반 정책과 충돌하지 않도록 정리
...
### 📦 설정
- 버전 범프: 1.4.3 → 1.4.4
- Android versionCode: 34 → 35

## v1.4.1 - 2026-05-27
### 📦 설정
- Play Store 프로덕션 출시용 버전 범프
- 버전 범프: 1.4.0 → 1.4.1
- Android versionCode: 31 → 32
